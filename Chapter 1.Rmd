...
[statistical_model]: figure/statistical_model.jpg "statistical_model"
...
[exemple_binomial]: figure/exemple_binomial.jpg "exemple_binomial"
...
$\ell_{Y = y} (\theta) \alpha P(Y = y | \theta)$
...
* a) Write the joint distribution of what will be observed and what will not be observed and what will not be observed.
...
If you care about $\theta$ $formula$

If you care about $\tilde y$ $formula$
